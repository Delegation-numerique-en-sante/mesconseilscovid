...
.. question:: Qu’est-ce qu’un test PCR salivaire ?
    ...
    Ce test est réalisé grâce au prélèvement de la salive, avec un écouvillon (long coton-tige) ou sans (par crachat). Moins contraignant que les tests nasopharyngés, il est recommandé **lorsque le prélèvement nasal est compliqué ou impossible** (très jeunes enfants, déviation de la cloison nasale, troubles psychiatriques…). Evaluée à 85%, sa fiabilité est inférieure (3 % à 11 %) à celle d'un test PCR nasopharyngé.
