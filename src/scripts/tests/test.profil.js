...
describe('Profil', function () {
    ...
    it('Le questionnaire est vide par défaut', function () {
        ...
        assert.deepEqual(profil.getData(), {
            ...
            vaccins: undefined,
            vaccins_type: undefined,
            _vaccins_start_date: undefined,
            _vaccins_start_date2: undefined,
            suivi_active: false,
    ...
    it('Le questionnaire peut être complètement rempli', function () {
        ...
        var data = {
            ...
            vaccins: true,
            vaccins_type: 'moderna',
            _vaccins_start_date: '2020-07-09T14:03:41.000Z',
            _vaccins_start_date2: '2020-07-09T14:03:41.000Z',
            suivi_active: true,
