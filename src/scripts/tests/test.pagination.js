...
describe('Pagination', function () {
    ...
    describe('Suivi', function () {
        ...
        it('ok d’aller à la page de déconfinement du suivi si profil complet et date symptômes et entrée(s) dans le suivi', function () {
            const profil = new Profil()
            profil.fillData({
                departement: '34',
                activite_pro: false,
            ...
            assert.isUndefined(
                redirectToUnansweredQuestions('suivideconfinement', profil)
            )
        })
