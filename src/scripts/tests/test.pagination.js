...
describe('Pagination', function () {
    ...
    describe('Suivi', function () {
        ...
        it('ok d’aller à l’historique du suivi si profil complet et date symptômes et au moins deux entrées dans le suivi', function () {
            const profil = new Profil()
            profil.fillData({
                departement: '34',
                activite_pro: false,
        ...
        it('redirige l’historique du suivi si profil complet et date symptômes mais une seule entrée dans le suivi', function () {
            const profil = new Profil()
            profil.fillData({
                departement: '34',
                activite_pro: false,
