...
const matrice = [
    ...
    {
        description: 'Positif (variante sud-africaine) et symptômes actuels graves',
        profil: {
            symptomes_actuels: true,
            symptomes_actuels_souffle: true,
            depistage: true,
            depistage_type: 'rt-pcr',
            depistage_resultat: 'positif',
            depistage_variante: '20H/501Y.V2',
            _depistage_start_date: new Date().toJSON(),
        },
    ...
    {
        description: 'Positif (variante sud-africaine) et symptômes actuels',
        profil: {
            symptomes_actuels: true,
            symptomes_actuels_diarrhee: true,
            depistage: true,
    ...
    {
        description: 'Positif (variante sud-africaine) et symptômes passés',
        profil: {
            symptomes_passes: true,
            depistage: true,
            depistage_type: 'rt-pcr',
    ...
    {
        description: 'Positif (variante sud-africaine) et contact à risque',
        profil: {
            contact_a_risque: true,
            contact_a_risque_contact_direct: true,
            depistage: true,
    ...
    {
        description:
            'Positif (variante sud-africaine) et contact à risque même lieu de vie',
        profil: {
            contact_a_risque: true,
            contact_a_risque_meme_lieu_de_vie: true,
            depistage: true,
    ...
    {
        description:
            'Positif (variante sud-africaine) et contact pas vraiment à risque',
        profil: {
            contact_a_risque: true,
            contact_a_risque_autre: true,
            depistage: true,
    ...
    {
        description: 'Positif (variante sud-africaine) et symptômes actuels autres',
        profil: {
            symptomes_actuels: true,
            symptomes_actuels_autre: true,
            depistage: true,
    ...
    {
        description: 'Positif (variante sud-africaine) et rien de tout ça',
        profil: {
            depistage: true,
            depistage_type: 'rt-pcr',
            depistage_resultat: 'positif',
    ...
    {
        description: 'Positif (variante brésilienne) et symptômes actuels graves',
        profil: {
            symptomes_actuels: true,
            symptomes_actuels_souffle: true,
            depistage: true,
            depistage_type: 'rt-pcr',
            depistage_resultat: 'positif',
            depistage_variante: '20J/501Y.V3',
            _depistage_start_date: new Date().toJSON(),
        },
        situation: 'positif_variante_d_interet_symptomes_actuels_graves',
        statut: 'positif-symptomatique-urgent',
    ...
    {
        description: 'Positif (variante brésilienne) et symptômes actuels',
        profil: {
            symptomes_actuels: true,
            symptomes_actuels_diarrhee: true,
            depistage: true,
    ...
    {
        description: 'Positif (variante brésilienne) et symptômes passés',
        profil: {
            symptomes_passes: true,
            depistage: true,
            depistage_type: 'rt-pcr',
    ...
    {
        description: 'Positif (variante brésilienne) et contact à risque',
        profil: {
            contact_a_risque: true,
            contact_a_risque_contact_direct: true,
            depistage: true,
    ...
    {
        description:
            'Positif (variante brésilienne) et contact à risque même lieu de vie',
        profil: {
            contact_a_risque: true,
            contact_a_risque_meme_lieu_de_vie: true,
            depistage: true,
    ...
    {
        description: 'Positif (variante brésilienne) et contact pas vraiment à risque',
        profil: {
            contact_a_risque: true,
            contact_a_risque_autre: true,
            depistage: true,
    ...
    {
        description: 'Positif (variante brésilienne) et symptômes actuels autres',
        profil: {
            symptomes_actuels: true,
            symptomes_actuels_autre: true,
            depistage: true,
    ...
    {
        description: 'Positif (variante brésilienne) et rien de tout ça',
        profil: {
            depistage: true,
            depistage_type: 'rt-pcr',
            depistage_resultat: 'positif',
