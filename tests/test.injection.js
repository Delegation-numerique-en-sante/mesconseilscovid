describe('Injection', function () {
    ...
    it('Caractéristiques (âge)', function () {
        var element = document.createElement('div')
        element.innerHTML = `
            <strong id="caracteristiques"></strong>
        `
        var data = {
            sup65: true,
        }
        ...
        chai.expect(element.innerHTML).to.equal(`
            <strong id="caracteristiques">vous êtes âgé·e de plus de 65&nbsp;ans.</strong>
        `)
    })
    ...
    it('Caractéristiques (grossesse)', function () {
        ...
        chai.expect(element.innerHTML).to.equal(`
            <strong id="caracteristiques">vous êtes au 3e trimestre de votre grossesse.</strong>
        `)
    })
    ...
    it('Caractéristiques (IMC)', function () {
        ...
        chai.expect(element.innerHTML).to.equal(`
            <strong id="caracteristiques">vous avez un IMC supérieur&nbsp;à&nbsp;30&nbsp;(67).</strong>
        `)
    })
    ...
    it('Caractéristiques (âge + IMC)', function () {
        ...
        chai.expect(element.innerHTML).to.equal(`
            <strong id="caracteristiques">vous êtes âgé·e de plus de 65&nbsp;ans et vous avez un IMC supérieur&nbsp;à&nbsp;30&nbsp;(67).</strong>
        `)
    })
    ...
    it('Caractéristiques (grossesse + IMC)', function () {
        ...
        chai.expect(element.innerHTML).to.equal(`
            <strong id="caracteristiques">vous êtes au 3e trimestre de votre grossesse et vous avez un IMC supérieur&nbsp;à&nbsp;30&nbsp;(67).</strong>
        `)
    })
    ...
    it('Antécédents (cardio)', function () {
        ...
        chai.expect(element.innerHTML).to.equal(`
            <strong id="antecedents">vous avez des antécédents à risque.</strong>
        `)
    })
    ...
    it('Antécédents (autres)', function () {
        ...
        chai.expect(element.innerHTML).to.equal(`
            <strong id="antecedents">vous avez une maladie chronique, un handicap ou vous prenez un traitement au long cours.</strong>
        `)
    })
    ...
    it('Antécédents (cardio + autres)', function () {
        ...
        chai.expect(element.innerHTML).to.equal(`
            <strong id="antecedents">vous avez des antécédents à risque et vous avez une maladie chronique, un handicap ou vous prenez un traitement au long cours.</strong>
        `)
    })
})
